...
class ReactAccessibleAccordion extends SandboxComponent {
  constructor(props) {
    super(props);
    this.state = {
  ...
  renderNotes () {
    return (
      <div className="app-body">
        <p>The github repository can be found at: <a href="https://github.com/springload/react-accessible-accordion">https://github.com/springload/react-accessible-accordion</a></p>
      </div>
    );
  }
...
export default ReactAccessibleAccordion;